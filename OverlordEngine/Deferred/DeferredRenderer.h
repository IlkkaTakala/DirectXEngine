...
public:
	...
	RenderTarget* GetNormalBuffer() { return m_GBuffer[int(eGBufferId::Normal)]; }
	RenderTarget* GetBloomBuffer() { return m_GBuffer[int(eGBufferId::Bloom)]; }
	RenderTarget* GetBuffer() { return m_GBuffer[int(eGBufferId::LightAccumulation)]; }
...
private:
	...
	RenderTarget* CreateRenderTarget(UINT width, UINT height, DXGI_FORMAT format, bool enableDepth = false) const; //Helper to construct RenderTargets
