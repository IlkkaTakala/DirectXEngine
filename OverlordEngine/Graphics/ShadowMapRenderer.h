...
public:
	...
	ID3D11ShaderResourceView* GetFarShadowMap() const;
	const XMFLOAT4X4& GetLightVP() const { return m_LightVP; }
	const XMFLOAT4X4& GetFarLightVP() const { return m_FarLightVP; }
	XMFLOAT2 GetSize() const { return { (float)m_Width, (float)m_Height }; }
